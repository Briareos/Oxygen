...
class Oxygen_Stream_Callable implements Oxygen_Stream_Interface
{
    ...
    {
        $this->source = $source;
        $this->buffer = new Oxygen_Stream_Buffer();
    ...
    private function pump($length)
    {
        if ($this->source) {
            do {
                ...
                if ($data instanceof Oxygen_Stream_Interface) {
                    $this->source = null;
                    $this->buffer = $data;
