 ...
 * @internal
 */
class Oxygen_Process_Pipes_UnixPipes extends Oxygen_Process_Pipes_AbstractPipes
{
    /** @var bool */
    private $ttyMode;
    /** @var bool */
    ...
    public function getDescriptors()
    {
        ...
        if ($this->ptyMode && Oxygen_Process_Process::isPtySupported()) {
            return array(
                array('pty'),
                array('pty'),
                array('pty'),
     ...
     *
     * @return Oxygen_Process_Pipes_UnixPipes
     */
