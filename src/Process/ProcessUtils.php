 ...
 */
class Oxygen_Process_ProcessUtils
{
    /**
    ...
    public static function validateInput($caller, $input)
    {
        if (null !== $input) {
            ...
            throw new Oxygen_Process_Exception_InvalidArgumentException(sprintf('%s only accepts strings or stream resources.', $caller));
        }
