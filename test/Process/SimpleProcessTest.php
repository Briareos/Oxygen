...
class SimpleProcessTest extends AbstractProcessTest
{
    ...
    {
        $this->expectExceptionIfPHPSigchild('Oxygen_Process_Exception_RuntimeException', 'This PHP has been compiled with --enable-sigchild. Term signal can not be retrieved');
    ...
    {
        $this->expectExceptionIfPHPSigchild('Oxygen_Process_Exception_RuntimeException', 'This PHP has been compiled with --enable-sigchild. The process can not be signaled.');
        parent::testSignal();
    }
    ...
    {
        $this->setExpectedException('Oxygen_Process_Exception_LogicException', 'Can not send signal on a non running process.');
    ...
    public function testSignalWithWrongIntSignal()
    {
        if ($this->enabledSigchild) {
            ...
            $this->setExpectedException('Oxygen_Process_Exception_RuntimeException', 'Error while sending signal `-4`.');
        }
    ...
    public function testSignalWithWrongNonIntSignal()
    {
        if ($this->enabledSigchild) {
            ...
            $this->setExpectedException('Oxygen_Process_Exception_RuntimeException', 'Error while sending signal `Céphalopodes`.');
        }
    ...
    {
        return new Oxygen_Process_Process($commandline, $cwd, $env, $input, $timeout, $options);
    }
