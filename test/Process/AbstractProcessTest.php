...
use Oxygen_Process_Exception_ProcessTimedOutException;
use Oxygen_Process_Exception_LogicException;
use Oxygen_Process_Exception_RuntimeException;
use Oxygen_Process_Pipes_PipesInterface;
...
abstract class AbstractProcessTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAllOutputIsActuallyReadOnTermination()
    {
        ...
        $expectedOutputSize = Oxygen_Process_Pipes_PipesInterface::CHUNK_SIZE * 2 + 2;
        ...
        // Here we don't call Oxygen_Process_Process::run or Oxygen_Process_Process::wait to avoid any read of pipes
        usleep(500000);
    ...
    public function testSetInputWhileRunningThrowsAnException()
    {
        ...
        } catch (Oxygen_Process_Exception_LogicException $e) {
     ...
     * @expectedException \Oxygen_Process_Exception_InvalidArgumentException
     * @expectedExceptionMessage Oxygen_Process_Process::setInput only accepts strings or stream resources.
     */
    ...
    public function testTTYCommand()
    {
        ...
        $this->assertSame(Oxygen_Process_Process::STATUS_TERMINATED, $process->getStatus());
    }
    ...
    public function testTTYInWindowsEnvironment()
    {
        ...
        $this->setExpectedException('Oxygen_Process_Exception_RuntimeException', 'TTY mode is not supported on Windows platform.');
        $process->setTty(true);
    }
    ...
    {
        if (!Oxygen_Process_Process::isPtySupported()) {
    ...
    /**
     * @expectedException \Oxygen_Process_Exception_ProcessFailedException
     */
    ...
    public function testStatus()
    {
        ...
        $this->assertSame(Oxygen_Process_Process::STATUS_READY, $process->getStatus());
        $process->start();
        $this->assertTrue($process->isRunning());
        $this->assertTrue($process->isStarted());
        $this->assertFalse($process->isTerminated());
        $this->assertSame(Oxygen_Process_Process::STATUS_STARTED, $process->getStatus());
        $process->wait();
        $this->assertFalse($process->isRunning());
        $this->assertTrue($process->isStarted());
    ...
    public function testProcessThrowsExceptionWhenExternallySignaled()
    {
        ...
        $this->setExpectedException('Oxygen_Process_Exception_RuntimeException', 'The process has been signaled with signal "9".');
        $process->wait();
    }
    ...
    public function testRunProcessWithTimeout()
    {
        ...
        } catch (Oxygen_Process_Exception_RuntimeException $e) {
        }
        $duration = microtime(true) - $start;

        if ('\\' === DIRECTORY_SEPARATOR) {
            // Windows is a bit slower as it read file handles, then allow twice the precision
            $maxDuration = $timeout + 2 * Oxygen_Process_Process::TIMEOUT_PRECISION;
        } else {
            $maxDuration = $timeout + Oxygen_Process_Process::TIMEOUT_PRECISION;
        }
    ...
    public function testIdleTimeout()
    {
        ...
        } catch (Oxygen_Process_Exception_ProcessTimedOutException $ex) {
    ...
    {
        $process = $this->getProcess('php -m');
        $this->setExpectedException('Oxygen_Process_Exception_LogicException', sprintf('Process must be started before calling %s.', $method));
        $process->{$method}();
    }
    ...
    public function testMethodsThatNeedATerminatedProcess($method)
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Oxygen_Process_Exception_LogicException', $e);
    ...
    public function testDisableOutputWhileRunningThrowsException()
    {
        $p = $this->getProcess('php -r "usleep(500000);"');
        $p->start();
        $this->setExpectedException('Oxygen_Process_Exception_RuntimeException', 'Disabling output while the process is running is not possible.');
        $p->disableOutput();
    }
    ...
    public function testEnableOutputWhileRunningThrowsException()
    {
        ...
        $p->disableOutput();
        $p->start();
        $this->setExpectedException('Oxygen_Process_Exception_RuntimeException', 'Enabling output while the process is running is not possible.');
        $p->enableOutput();
    }
    ...
    public function testDisableOutputWhileIdleTimeoutIsSet()
    {
        ...
        $process->setIdleTimeout(1);
        $this->setExpectedException('Oxygen_Process_Exception_LogicException', 'Output can not be disabled while an idle timeout is set.');
    ...
    public function testSetIdleTimeoutWhileOutputIsDisabled()
    {
        $process = $this->getProcess('sleep 3');
        $process->disableOutput();
        $this->setExpectedException('Oxygen_Process_Exception_LogicException', 'Idle timeout can not be set while the output is disabled.');
        $process->setIdleTimeout(1);
    }
    ...
    public function provideStartMethods()
    {
        return array(
            ...
            array('mustRun', 'Oxygen_Process_Exception_LogicException', 'Output has been disabled, enable it to allow the use of a callback.'),
        );
    }
    ...
    public function testGetOutputWhileDisabled($fetchMethod)
    {
        ...
        $p->disableOutput();
        $p->start();
        $this->setExpectedException('Oxygen_Process_Exception_LogicException', 'Output has been disabled.');
        $p->{$fetchMethod}();
    }
